...
echo ""
echo "Testing http://192.168.0.10:8000/health (Frontend URL)"
curl -s http://192.168.0.10:8000/health

echo -e "\n\033[1;36m=== Testing Frontend → Backend Connection ===\033[0m"
docker exec grp_frontend sh -c "wget -qO- http://192.168.0.10:8000/health || echo 'Frontend CANNOT reach backend!'"
...
echo -e "  Frontend → Backend API (192.168.0.10:8000)"
